...
export class ImageCompress {
   ...
   */
  static uploadFile(render: Renderer2):Promise<{images: string[], orientation: DOC_ORIENTATION}> {

    const promise: Promise<{images: string[], orientation: DOC_ORIENTATION}> = new Promise(function(resolve, reject) {
        ...
        myReader.onloadend = (e) => {
          try {
            ImageCompress.getOrientation(files[i], orientation => {
              ...
              imageArray.orientation = orientation;
